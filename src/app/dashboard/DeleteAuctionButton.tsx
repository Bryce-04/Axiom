...
export function DeleteAuctionButton({ auctionId }: { auctionId: string }) {
  ...
  return (
    <button
      ...
      className="rounded-md border border-neutral-200 dark:border-neutral-700 px-3 py-1.5 text-xs font-medium text-neutral-400 hover:border-red-300 hover:text-red-600 dark:hover:border-red-800 dark:hover:text-red-400 transition-colors"
    >
      Delete
    </button>
  )
